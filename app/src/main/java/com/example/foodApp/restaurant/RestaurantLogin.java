    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_forgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RestaurantLogin.this, RestaurantResetPasswordActivity.class));
            }
        });
        ...
        tv_registerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(RestaurantLogin.this, RestaurantRegister.class));
            }
        });
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(RestaurantLogin.this, "Login Successful", Toast.LENGTH_SHORT).show();
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(RestaurantLogin.this, "Login Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
