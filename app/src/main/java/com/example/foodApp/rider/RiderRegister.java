...
public class RiderRegister extends AppCompatActivity {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        reference = FirebaseDatabase.getInstance().getReference().child(RiderRegister.RIDER_USERS).child(userId);
    ...
    private void sendUserToMainActivity() {
        Intent intent = new Intent(RiderRegister.this, RiderDashboard.class);
